...
using HQF.Daily.Configuration.Ui;
using HQF.Daily.Sessions;
using HQF.Daily.Web.Models;
using HQF.Daily.Web.Models.Layout;

namespace HQF.Daily.Web.Controllers
{
    public class LayoutController : DailyControllerBase
    {
